...
using Microsoft.OpenApi.Models;
using AddressStandardizationService.Profiles;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<IDadataService, DadataService>(client =>
            {
                ...
                client.DefaultRequestHeaders.Add("Authorization", $"Token {Configuration["Dadata:ApiKey"]}");
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AddressStandardizationService v1"));
            }
